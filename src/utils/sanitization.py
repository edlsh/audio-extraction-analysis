...
class PathSanitizer:
    ...
    def sanitize_filename(filename: str, replacement: str = "_") -> str:
        ...
        """
        # First, strip control characters (including \n, \r, \t, etc.)
        sanitized = _CONTROL_CHARS.sub(replacement, filename)

        # Remove or replace invalid filename characters
        # Keep alphanumeric, dots, hyphens, underscores, and spaces
        sanitized = _FILENAME_INVALID.sub(replacement, sanitized)
    ...
    def sanitize_dirname(dirname: str, replacement: str = "_") -> str:
        ...
        """
        # First, strip control characters (including \n, \r, \t, etc.)
        sanitized = _CONTROL_CHARS.sub(replacement, dirname)

        # Similar to filename but more restrictive
        # Remove or replace invalid directory name characters
        sanitized = _DIRNAME_INVALID.sub(replacement, sanitized)
