...
class EventConsumer:
    ...
    async def _run_loop(self) -> None:
        ...
        while self._running:
            ...
            sentinel_received = await self._collect_events_until_deadline(loop, deadline)
    ...
    async def _collect_events_until_deadline(
        self, loop: asyncio.AbstractEventLoop, deadline: float
    ) -> bool:
        """Collect events until deadline. Returns True if sentinel received."""
