...
class TestUtilsPackage:
    ...
    def test_retry_budget_exported(self):
        """Test that RetryBudget is accessible from src.utils."""
        import src.utils

        # RetryBudget should be directly accessible from src.utils
        assert hasattr(src.utils, "RetryBudget")

        # And from the retry submodule
        from src.utils.retry import RetryBudget

        assert src.utils.RetryBudget is RetryBudget
